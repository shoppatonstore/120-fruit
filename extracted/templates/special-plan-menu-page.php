<?php
/**
 * Special Plan Menu Page Template
 * Use shortcode: [ftp_special_plan_menu_full]
 */
...
<div class="ftp-wrapper">
    ...
    <section class="ftp-menu-full ftp-section" id="ftp-special-plan-menu-full">
        <div class="ftp-container">
            <div class="ftp-section-header ftp-fade-in-up">
                <h1 class="ftp-section-title">Special Plan Menu</h1>
                <p class="ftp-section-subtitle">Therapeutic fruit salads and smoothies designed to help you achieve your specific health and wellness goals. Order directly via WhatsApp for quick delivery!</p>
            </div>
            ...
            <nav class="ftp-menu-nav">
                <div class="ftp-menu-nav-list">
                    ...
                    <a href="#plan-menu-<?php echo esc_attr($key); ?>" class="ftp-menu-nav-item">
            ...
            <!-- Menu Categories -->
            <?php foreach ($menu_items as $key => $category) : ?>
            <div class="ftp-menu-category" id="plan-menu-<?php echo esc_attr($key); ?>">
                ...
                <div class="ftp-menu-items-grid">
                    ...
                    <div class="ftp-menu-item-card ftp-fade-in-up">
                        <div class="ftp-menu-item-content">
                            ...
                            <?php 
                            $whatsapp_url = ftp_whatsapp_url(ftp_get_support_phone(), "Hello 120! I would like to order " . $item['name'] . " (" . $item['price'] . "). Please confirm availability.");
                            ?>
                            <a href="<?php echo esc_url($whatsapp_url); ?>" class="ftp-btn ftp-btn-primary ftp-btn-small" target="_blank" rel="noopener">
                                Order Now
                            </a>
                        </div>
                    </div>
            ...
            <div class="ftp-section-cta ftp-fade-in-up">
                ...
                <?php $whatsapp_url = ftp_whatsapp_url(ftp_get_support_phone(), "Hello 120 Fruit Therapy! I would like to order from the Special Plan Menu for delivery within Nsukka. Please assist me."); ?>
